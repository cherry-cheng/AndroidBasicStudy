...
import com.cyh.leafdemo.AnimationUtils;
import com.cyh.leafdemo.LeafLoadingView;

import java.util.Random;

public class LeafActivity extends Activity implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    public static final int REFRESH_PROGRESS = 0x10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.leaf_load_activity);
        initViews();
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        if (seekBar == mAmpireSeekBar) {
            ...
            mLeafLoadingView.setmLeafFloatTime(progress);
            mFloatTimeText.setText(getResources().getString(R.string.current_float_time,
                    progress));
        }
        else if (seekBar == mRotateTimeSeekBar) {
            mLeafLoadingView.setmLeafRotateTime(progress);
