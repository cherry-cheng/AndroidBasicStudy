package com.weizhan.myrecyclerviewdemo;
...
import com.weizhan.myrecyclerviewdemo.immersive.ImmersiveActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateSuspensionBar() {
        Picasso.with(this)
                .load(getAvartarResId(mCurrentPosition))
                .centerInside()
                .fit()
                .into(mSuspensionIv);
        mSuspensionTv.setText("MyRecy " + mCurrentPosition);
    }

    private int getAvartarResId(int position){
        switch (position % 4){
            case 0:
